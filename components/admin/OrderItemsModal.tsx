...
// - Production status workflow: new → in_progress → baked → assembled → creamed → decorated
...
type ProductionStatus = 'new' | 'in_progress' | 'baked' | 'creamed' | 'assembled' | 'decorated';
...
const statusOptions: { value: ProductionStatus; label: string; color: string }[] = [
  ...
  { value: 'assembled', label: 'Собран', color: 'bg-violet-100 text-violet-700 border-violet-300' },
